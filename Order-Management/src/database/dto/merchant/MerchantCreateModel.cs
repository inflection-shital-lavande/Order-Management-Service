...
namespace Order_Management.src.database.dto.merchant
{
    public class MerchantCreateModel
    {
        ...
        [StringLength(36, ErrorMessage = "ReferenceId should be a valid UUID")]
        ...
        [MinLength(5, ErrorMessage = "Website URL must be at least 5 characters long")]
        [MaxLength(512, ErrorMessage = "Website URL can be a maximum of 512 characters")]
