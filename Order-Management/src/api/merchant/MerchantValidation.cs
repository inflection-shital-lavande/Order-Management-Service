        ...
        public AddMerchantDTOValidator()
        {
            ...
            RuleFor(x => x.Name)
               // .NotEmpty().WithMessage("Name is required.")
                ...
                .MaximumLength(512).WithMessage("Name can be a maximum of 512 characters.");
            ...
            RuleFor(x => x.Email)
                ...
                //.MaximumLength(512).WithMessage("Email can be a maximum of 512 characters.");

            RuleFor(x => x.Phone)
                 .MinimumLength(2).WithMessage("Phone number must be at least 2 characters long.")
                .MaximumLength(12).WithMessage("Phone number can be a maximum of 12 characters.");
               // .When(x => !string.IsNullOrEmpty(x.Phone));

            RuleFor(x => x.Logo)
                //.NotEmpty()
                .MinimumLength(5).WithMessage("Logo URL must be at least 5 characters long.")
                .MaximumLength(512).WithMessage("Logo URL can be a maximum of 512 characters.")
             .When(x => !string.IsNullOrEmpty(x.Logo));

            RuleFor(x => x.WebsiteUrl)
                .MinimumLength(5).WithMessage("Website URL must be at least 5 characters long.")
                .MaximumLength(512).WithMessage("Website URL can be a maximum of 512 characters.");


            RuleFor(x => x.TaxNumber)
                //.NotEmpty()
                .MinimumLength(2).WithMessage("Tax number/code must be at least 2 characters long.")
                .MaximumLength(64).WithMessage("Tax number/code can be a maximum of 64 characters.");
                

            RuleFor(x => x.GSTNumber)
                //.NotEmpty()
                .MinimumLength(2).WithMessage("GST number/code must be at least 2 characters long.")
                .MaximumLength(64).WithMessage("GST number/code can be a maximum of 64 characters.")
